...
- TypeScript and application lint checks pass. Vendored UI components are excluded from application lint; unused starter components and the generated mobile hook have been removed.
...
| Public preview, no cuts | 0.000 s removed; all six cues unchanged |
| Public preview, reversed range | Clear error; previous report removed |
